...
<body class="d-flex flex-column min-vh-100" id="body">
    <div class="container" id="content">
        ...
        <nav class="navbar navbar-expand-lg navbar-light m-4">
            <div class="container-fluid">
				...
				<div>
					<div class="messapia-regular">Cocacola</div>
					<div class="strap_under"><center>Refreshing the world, one story at a time</center></div>
				</div>
				</a>
				...
				aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a tabindex="0" class="nav-link" role="button" data-bs-toggle="popover" data-bs-trigger="focus" title="About Web 3D Applications" data-bs-content="3D Apps is a final year module ...">About</a>
                            </li>
    ...
    <footer class="mt-auto" id="footer">
        <div class="text-center mt-4 mb-4">&copy 2022 Mobile Web 3D Applications <a href="javascript:swap_theme()">Switch Theme</a> | <a href="https://github.com/aurora-dot/Web-3D-Assignment">GitHub</a></div>
    </footer>
